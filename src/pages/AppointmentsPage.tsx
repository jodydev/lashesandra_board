      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-pink-50/30 dark:from-gray-950 dark:via-gray-900 dark:to-pink-950/20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-8">
            ...
            <div className="h-12 bg-gray-200 dark:bg-gray-800 rounded-xl w-48 animate-pulse mt-4 sm:mt-0" />
          </div>
          ...
          <div className="flex flex-col lg:flex-row gap-4 items-start lg:items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              {[
                ...
                { key: 'questa_settimana', label: 'Questa Settimana', count: 0 },
                { key: 'questo_mese', label: 'Questo Mese', count: 0 }
              ].map((filter) => (
                <motion.button
                  key={filter.key}
            ...
            {filteredAppointments.map((appointment, index) => {
              ...
              return (
                <motion.div
                  ...
                  className={`group relative backdrop-blur-xl rounded-2xl p-6 border shadow-sm transition-all duration-300 ${
                  ...
                  <div className="flex items-center justify-between">
                      ...
                      <div className="space-y-2">
                        <div className="flex items-center gap-4">
                          ...
                          <span className={`px-3 py-1 rounded-full text-xs font-medium flex items-center gap-1 ${statusInfo.color}`}>
                            {statusInfo.isCompleted && <Check className="w-3 h-3" />}
                            {statusInfo.status}
                          </span>
                        </div>
                    ...
                    <div className="flex items-center gap-3">
                      <motion.button
                        ...
                        className={`p-3 rounded-xl transition-colors duration-200 group/btn ${
                          statusInfo.isCompleted 
